...
{
    /* Bit generator */
    TEST_ASSERT_EQUAL_UINT32(1, CM_U32_BIT(0));
    TEST_ASSERT_EQUAL_UINT32(128, CM_U32_BIT(7));
    TEST_ASSERT_EQUAL_UINT32(2147483648, CM_U32_BIT(31));

    /* Bit set */
    TEST_ASSERT_FALSE(CM_U32_CHECK_BIT_SET(0, 0));
    TEST_ASSERT_FALSE(CM_U32_CHECK_BIT_SET(15, CM_U32_BIT(4)));
    TEST_ASSERT_TRUE(CM_U32_CHECK_BIT_SET(1, CM_U32_BIT(0)));
    TEST_ASSERT_TRUE(CM_U32_CHECK_BIT_SET(255, CM_U32_BIT(3)));
    TEST_ASSERT_TRUE(CM_U32_CHECK_BIT_SET(4294967295, CM_U32_BIT(31)));
}
